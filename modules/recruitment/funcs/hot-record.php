...
$db->sqlreset()
  ->select( 'COUNT(*)' )
  ->from( NV_PREFIXLANG . '_' . $module_data . '_record t1' )
  ->join( 'INNER JOIN ' . NV_PREFIXLANG . '_' . $module_data . '_record_highlights t2 ON t1.id=t2.record_id' )
...
$contents = nv_theme_recruitment_list_record_detail( $array_data, $generate_page );

$page_title = $lang_module['hot_record'];
