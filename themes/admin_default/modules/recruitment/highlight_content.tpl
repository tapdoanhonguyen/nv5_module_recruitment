...
<script type="text/javascript">
	...
	$('#frm-highlights').submit(function(){
		$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=highlight_content&nocache=' + new Date().getTime(), $( this ).serialize(), function(res) {
			...
			if (r_split[0] != 'OK') {
				...
				if( $('#is_edit').val() == '1' ){
					...
					setTimeout(function(){
						window.location = 'index.php?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=highlights';
					}, 1000);
				}
				else{
